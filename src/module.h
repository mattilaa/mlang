...
public:
    ...
    std::vector<FunctionDefNode*> getModuleFunctions(const std::string& moduleName);
    
    // Get a specific function from a module
    FunctionDefNode* getFunction(const std::string& moduleName, const std::string& funcName);
