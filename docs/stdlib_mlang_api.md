...
- Stdlib API documentation uses lowercase public type names such as `mutex`,
  ...
  `Vec<T>` is the exception because lowercase `vec` is already used by the
...
- [std::matrix](stdlib/std_matrix.md)
- [std::multiarray](stdlib/std_multiarray.md)
- [std::mutmultiarray](stdlib/std_mutmultiarray.md)
...
- [std::limits](stdlib/std_limits.md)
