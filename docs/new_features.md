...
| Audio hardware output | List output devices by integer id, print device names, and open the default or selected output through `std::audio`, using CoreAudio on macOS or JACK2 on Linux; see [`examples/std_audio_sine_demo.mla`](../examples/std_audio_sine_demo.mla), [`examples/std_audio_vst3_style_preview.mla`](../examples/std_audio_vst3_style_preview.mla), [`examples/std_audio_simd_dsp_demo.mla`](../examples/std_audio_simd_dsp_demo.mla), and [`examples/package_manager_vst3_coreaudio_synth`](../examples/package_manager_vst3_coreaudio_synth). Reference: [Stdlib Module API](stdlib_mlang_api.md#stdaudio). |
