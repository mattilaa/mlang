...
| Math, rand, hash, FFT, and algorithms | Use numeric helpers, random values, hashes, FFT utilities, and algorithms; see [`examples/std_math_demo.mla`](../examples/std_math_demo.mla), [`examples/std_rand_demo.mla`](../examples/std_rand_demo.mla), [`examples/std_hash_demo.mla`](../examples/std_hash_demo.mla), [`examples/std_fft_demo.mla`](../examples/std_fft_demo.mla), and [`examples/fft_example/main.mla`](../examples/fft_example/main.mla). Reference: [Stdlib Module API](stdlib/std_math.md). |
