...
- treat those returned [`str8`](Quick-Guide#types) values as read-only and do not call [`std::strbuf::free(...)`](Stdlib-Strbuf) on them
...
- `cursor_command` (alias of [`i32`](Quick-Guide#types))
- `cursor_direction` (alias of [`i32`](Quick-Guide#types))
