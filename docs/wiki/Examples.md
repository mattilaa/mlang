...
square [`f64`](Quick-Guide#types) matrix and enables `I` inverse, `D` determinant, `E` eigenvectors,
...
- `examples/matrix_operations.mla` — element-wise matrix arithmetic, scalar
  ...
  inverse, determinant, and eigen operations on a sized square [`f64`](Quick-Guide#types) matrix.
