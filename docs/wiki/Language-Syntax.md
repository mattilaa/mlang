...
<a id="language_syntax"></a>

# Mlang Language Syntax Updates
...
- [`str8`](Quick-Guide#types) is the UTF-8 string type.
- [`str16`](Quick-Guide#types) is the UTF-16 string type.
...
[`std::bits::ON()`](Stdlib-Bits) and [`std::bits::OFF()`](Stdlib-Bits).
...
- [`std::bitset::BitSet`](Stdlib-Bitset) stores values densely at one bit per entry

<a id="builder_syntax"></a>

## Builder Syntax (`add<T>(...)` and clause keys)
...
- Strings ([`str8`](Quick-Guide#types) / [`str16`](Quick-Guide#types)).
