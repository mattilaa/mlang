...
### Integer Types
- Signed integers: [`i8`](Quick-Guide#types), [`i16`](Quick-Guide#types), [`i32`](Quick-Guide#types), [`i64`](Quick-Guide#types)
- Unsigned integers: [`u8`](Quick-Guide#types), [`u16`](Quick-Guide#types), [`u32`](Quick-Guide#types), [`u64`](Quick-Guide#types)
...
### Variables
- [`let`](Language-Syntax) declarations (immutable)
- [`var`](Language-Syntax) declarations (mutable)
- Reassignment
...
### Control Flow
- [`if`](Language-Syntax) statements
- `else if` chains
- [`else`](Language-Syntax) blocks
- Nested conditionals

### Loops
- [`for`](Language-Syntax) loops with ranges (`for i in 0..10`)
- Nested loops
