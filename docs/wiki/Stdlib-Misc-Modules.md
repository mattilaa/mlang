...
- scalar FFT preprocessing plus [`std::algorithm::fft`](Stdlib-Algorithm-Fft) vs [`std::simd`](Stdlib-Simd)
  preprocessing plus [`std::simd::fft_forward`](Stdlib-Simd) / [`std::simd::fft_inverse`](Stdlib-Simd)
