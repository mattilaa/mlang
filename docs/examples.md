...
- `examples/ga_tsp_esc` — animated `std::esc` genetic travelling-salesman
...
- `examples/multiarray.mla` — fixed-size multidimensional arrays, nested-brace
  initialization, and chained indexing.
...
- `examples/package_manager_reverb2_trance` — configurable-BPM bass-drum,
  ...
  the independently implemented `dsp::reverb2`. It includes the
