...
- `plugins/mla_verb`, `plugins/mla_distortion`, `plugins/mla_delay`, `plugins/mla_eq` — VST3 effects: DSP in MLang (`modules/dsp/*`), thin C++ `plugin.cpp` wrapper. Output bundle lands in `<plugin>/build/cmake/VST3/`.
