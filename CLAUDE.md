...
- `plugins/mla_verb`, `plugins/mla_distortion` — VST3 effects: DSP in MLang (`modules/dsp/*`), thin C++ `plugin.cpp` wrapper. Output bundle lands in `<plugin>/build/cmake/VST3/`.
