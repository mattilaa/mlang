...
def main():
    with tempfile.TemporaryDirectory(prefix="mlacker-session-") as directory:
        ...
        try:
            ...
            assert b"Load MIDI learn (.mlalearn)" in tui.send(F1 + b"llllllljjj\r")
            ...
            frame = tui.send(F1 + b"llllllljjjj\r")
