...
| Filter | None, Lowpass 12, Lowpass 24, Highpass 12, Highpass 24, Bandpass 12, Bandpass 24, Moog 12, Moog 24 | Lowpass 12 |
...
7 Moog 12, 8 Moog 24 (0 is None). Resonance `0..1` maps to `0..24 dB`. Type
changes crossfade over Filter Ramp. Sessions saved before this order will
recall a different filter type; reselect it once.
