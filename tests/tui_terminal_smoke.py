...
def main():
    ...
    try:
        ...
        def track_menu(keys):
            ...
            assert b"Create MIDI track" in read_frame(None)
            os.write(master, keys)
        ...
        # The helper already checked the create entries are listed.
        track_menu(b"")
        os.write(master, b"\r")
